...
![Windows 环境漏洞复现与 SMB 回连证据](/assets/posts/rabbitmq-management-unc-ssrf/f084b21a610117d377d8668b030ba4d4.png)

![隔离环境中的漏洞复现结果](/assets/posts/rabbitmq-management-unc-ssrf/20260714224054583.png)
...
![RabbitMQ Management 路由构建逻辑](/assets/posts/rabbitmq-management-unc-ssrf/20260715000506783.png)
![management.path_prefix 配置读取逻辑](/assets/posts/rabbitmq-management-unc-ssrf/20260715000928099.png)
...
![静态资源通配路由与处理器定位](/assets/posts/rabbitmq-management-unc-ssrf/20260714231612111.png)
...
![rabbit_mgmt_wm_static 多目录文件探测分支](/assets/posts/rabbitmq-management-unc-ssrf/20260714225723596.png)
