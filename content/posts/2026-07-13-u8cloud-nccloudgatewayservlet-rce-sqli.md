...
date: 2026-07-13
publishedAt: 2026-07-13T14:49:33+08:00
category: 漏洞分析
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/skn25tsxmf.png)


跟踪ServletForGW，顶部是一堆私有属性

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/bsaeyh3tez.png)

查看结构：

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/er6eiqtfud.png)

发现只有doAction方法可以接收HTTP参数，猜测此方法为入口，继续往下看：
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/5xe06ovfck.png)


从HTTP请求头部获取一个gatewaytoken请求头使用checkGateWayToken进行校验，跟进此方法

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/qdv75tzyg4.png)

此处的nctoken是传输过程中的明文token，其处理流程是对后续的nccloud.gateway.nctoken进行encode和decode加解密操作。

查看nccloud.gateway.nctoken：

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/ubeah3vfct.png)

发现是加密过后的，那就跟进一下上一步的encode、decode，跟踪到Encode.class

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/soet2ei4g0.png)

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/k3rz1w2h34.png)

应该是AES，密钥也有
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/aue3txm253.png)


到此token获取成功，回到ServletForGW继续审计
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/cjepx7u1cm.png)


创建一个json对象后从request里获取请求数据。

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/5ztrtlu246.png)

发现调用callNCService()，所以继续往下看
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/5jpn83ubsf.png)
反射
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/77vmwibegv.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/h86of72cqo.png)

黑名单封了两个类，掩耳盗铃有点

IActionInvokeService：
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/g55ahhuot1.png)


跟进实现：
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/xj8bu08zla.png)


跟进exec:

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/kxlrv3w659.png)

ProcessFileUtils：

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/tbxr2qd9fm.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/pyca8jiop5.png)

需要注意的是

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/dbkb6bvldi.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/9qe5h7mm89.png)


![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/xt1lt9ba6v.png)


#### 总结

整体思路：
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/kbfx6b1hms.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/ncbq1cquve.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/whcxv3mbb6.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/k016wq4s3v.png)


跟踪一下实现
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/zie68r46x7.png)


再跟踪retrieveByClause
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/2tdgetxa81.png)


发现这个类有很多重载，找到一个可能的点

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/7u24xyi4lv.png)

跟踪buildSql进去
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/2mhlint5dq.png)
...
![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/7cue3bcglx.png)


最后晒一个武器化

![image.png](/assets/posts/u8cloud-nccloudgatewayservlet-rce-sqli/qx2be3vvfd.png)
